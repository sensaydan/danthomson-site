      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="text-2xl font-bold">
              <span className="gradient-text">Dan Thomson</span>
            </Link>
            <p className="mt-4 text-zinc-400 max-w-md">
              Building the future of AI and digital immortality. Explorer of ideas, 
              countries, and the edges of what&apos;s possible.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              {["About", "Projects", "Speaking", "Contact"].map((item) => (
                <li key={item}>
                  <Link
        ...
        <div className="mt-12 pt-8 border-t border-zinc-800/50 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-zinc-500 text-sm">
            © {new Date().getFullYear()} Dan Thomson. All rights reserved.
          </p>
          <p className="text-zinc-600 text-sm">
            Freedom · Adventure · Innovation · Digital Immortality
          </p>
        </div>
      </div>
    </footer>
